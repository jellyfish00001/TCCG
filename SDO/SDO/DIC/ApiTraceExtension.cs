...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    {
        public static IServiceCollection AddApiTrace(this IServiceCollection services)
        {
            //Transient
            ...
            services.TryAddScoped<ITraceDac, TraceDac>();
            services.TryAddScoped<IApiTrace, ApiTrace>();
            return services;
        }
    }
}
