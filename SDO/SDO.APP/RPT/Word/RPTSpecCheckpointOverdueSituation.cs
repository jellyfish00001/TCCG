...
{
    public class RPTSpecCheckpointOverdueSituation : WordBuilder
    {
        public RPTSpecCheckpointOverdueSituation(IComponentContext coms) : base(coms)
        {
        }
        ...
        protected override async Task<bool> MakeContent()
        {
            ...
            await CreateService<RPTSpecCheckpointExpiry>(objData, "SpecCheckpointOverdueSituation").MakeContent();
            return true;
        }
    }
}
