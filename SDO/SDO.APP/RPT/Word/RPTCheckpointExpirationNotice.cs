...
{
    public class RPTCheckpointExpirationNotice : WordBuilder
    {
        public RPTCheckpointExpirationNotice(IComponentContext coms) : base(coms)
        {
        }
        ...
        protected override async Task<bool> MakeContent()
        {
            ...
            await CreateService<RPTCheckpointExpirationNotice>(objData, "CheckpointExpirationNotice").MakeContenByTemplate();
            return true;
        }
    }
}
