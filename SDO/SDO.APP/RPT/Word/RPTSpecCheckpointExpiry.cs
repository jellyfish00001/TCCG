...
{
    public class RPTSpecCheckpointExpiry : WordBuilder
    {
        public RPTSpecCheckpointExpiry(IComponentContext coms) : base(coms)
        {
        }
        ...
        protected override async Task<bool> MakeContent()
        {
            ...
            await CreateService<RPTSpecCheckpointExpiry>(objData, "SpecCheckpointExpiry").MakeContent();
            return true;
        }
    }
}
