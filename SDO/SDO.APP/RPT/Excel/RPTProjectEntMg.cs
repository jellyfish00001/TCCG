...
namespace SDO.APP.RPT.Excel
{
    ...
    /// 各年度提案數統計表
    /// </summary>
    public class RPTProjectEntMg : XlsBuilder
    {
        ...
        public RPTProjectEntMg(IComponentContext coms) : base(coms)
        {
            TemplateFileName = "ProjectEntMg.xlsx";
        ...
        protected override async Task GetData()
        {
            ...
            data = await pwsRptDac.GetEntPlanMg(pwsRptModel);
        }
