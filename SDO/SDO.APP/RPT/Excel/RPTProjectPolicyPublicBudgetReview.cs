...
namespace SDO.APP.RPT.Excel
{
    ...
    /// 各年度提案數統計表
    /// </summary>
    public class RPTProjectPolicyPublicBudgetReview : XlsBuilder

    {
        ...
        public RPTProjectPolicyPublicBudgetReview(IComponentContext coms) : base(coms)
        {
            TemplateFileName = "ProjectPolicyPublicBudgetReview.xlsx";
        ...
        protected override void MakeContent()
        {
            ...
            foreach (RPTBudgeReviewModel item in data)
            {
                ...
                SetColumn(cells[$"L{row}"], item.ADVIEWDESC);                               // 審查意見
