...
namespace SDO.APP.RPT.Excel
{
    ...
    /// 各年度提案數統計表
    /// </summary>
    public class RPTPolicyFundBudgetReview : XlsBuilder
    {
        ...
        public RPTPolicyFundBudgetReview(IComponentContext coms) : base(coms)
        {
            TemplateFileName = "PolicyFundBudgetReview.xlsx";
