...
import ProjectChapterRoutePanel from '../Page/INN/ProjectChapter/ProjectChapterRoutePanel';
...
import {ChapterPageIndexProvider} from "../Page/INN/ProjectChapter/ChapterPageIndexProvider"
...
const RootRoute = (props) => {
    ...
    useEffect(() => {
        ...
        setHeaderFooterStatus(href.includes("ProjectChapter"));
        setLoading(true);
    }, [])
