    ...
    return (
        ...
        >
            <TabStrip selected={selected} onSelect={handleSelect} className="tab-content">
                ...
                <TabStripTab title="計畫調整通知">
                    <MailSetGrid data={gridData.filter(x => x.MAIL_TYPE == "B")} loadData={loadData} />
                </TabStripTab>
                <TabStripTab title="計畫撤銷通知">
                    <MailSetGrid data={gridData.filter(x => x.MAIL_TYPE == "C")} loadData={loadData} />
                </TabStripTab>
                <TabStripTab title="每月填報提醒">
                    <MailSetGrid data={gridData.filter(x => x.MAIL_TYPE == "D")} loadData={loadData} />
                </TabStripTab>
            </TabStrip>
        </PageContainer >
    );
