...
import ProjectChapterRoutePanel from '../Page/PWS/ProjectChapter/ProjectChapterRoutePanel';
import ProjectPrint from '../Page/PWS/ProjectPrint/ProjectPrintMain';
import ProjectAdjustContent from '../Page/PWS/ProjectAdjustContent/ProjectAdjustContentMain';
...
import { ChapterPageIndexProvider } from '../Page/PWS/ProjectChapter/ChapterPageIndexProvider';
...
const RootRoute = (props) => {
    ...
    // 判斷哪些頁面需要顯示HeaderFooter
    useEffect(() => {
        let href = window.location.href;
        setHeaderFooterStatus(href.includes("ProjectChapter") || href.includes("ProjectPrint"));
        setLoading(true);
    }, [])
