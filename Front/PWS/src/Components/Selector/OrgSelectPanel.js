...
const OrgSelectPanel = (props) => {
    ...
    const onSelect = (event) => {
        props.onSelect({ 
            OU_ID: event.target.props.OU_ID,
            CREATEUNITOUID: event.target.props.CREATEUNITOUID,
            PLANKIND: event.target.props.PLANKIND,
            SEND_STATUS: event.target.props.SEND_STATUS,
        });
    }
