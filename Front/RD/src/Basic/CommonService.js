...
import { IsNullOrEmpty, openPage, FormatDate } from './SDOExtension';
 ...
 */
export const getSysYearMonth = () => {
    // 取得系統民國日期
    const systemDate = FormatDate(new Date(), 'tYY/MM/DD');
    // 以 / 符號分割，變陣列
    const systemDateArr = systemDate.split('/')
    return systemDateArr;
}
...
* @param {*} identityField 
*/
export const downProjectAttachment = async (identityField ,dbkey = 6) => {
