...
import { initQueryData, getAllDropDowns, projAwStatusDefaultList } from "./ProjectAdjustListReviewService";
...
export const ProjectAdjustListtReviewQueryForm = props => {
    ...
    const initForm = async (dropDownDatas) => {
        ...
        let dropDownData = {
            ...
            SPEC_NOTE: dropDownDatas[1],
            EXEC_ORGAN_C: dropDownDatas[2]
        };
        ...
        let defaultValue = {
            ...
            SPEC_NOTE: dropDownDatas[1][0] ? dropDownDatas[1][0].value : '',
            EXEC_ORGAN_C: dropDownDatas[2][0] ? dropDownDatas[2][0].value : '',
        };
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <DropDownListWithValue
                                                    // @ts-ignore
                                                    data={dropDownData.PROJECT_YEAR}
                                                    textField={"text"}
                                                    dataItemKey={"value"}
                                        ...
                                        <tr>
                                            ...
                                            <td >
                                                <MultiSelect
                                                    ...
                                                    data={dropDownData.PROJECT_AW_STATUS}
                                                    textField="text"
                                                    dataItemKey="value"
                                                    onChange={(e) => {
                                                        // @ts-ignore
...
export default ProjectAdjustListtReviewQueryForm;