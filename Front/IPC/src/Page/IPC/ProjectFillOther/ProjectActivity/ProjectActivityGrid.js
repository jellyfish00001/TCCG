...
export const ProjectActivityGrid = (props) => {
    ...
    return (
        <>
            ...
            >
                ...
                <GridColumn field="ACTIVITY_NAME" title="活動名稱" cell={textAreaCell} headerCell={RequiredHeaderCell} />
                <GridColumn field="ACTIVITY_DATE" title="活動日期" cell={twDatePickerCell} headerCell={RequiredHeaderCell} />
            </Grid>
        </>
    )
}
export default ProjectActivityGrid;